...
static const struct vd55g_fw_revision_map vd55g0_fw_maps[] = {
	{ .revision = 0x1111, .needs_patch = true, .fw_name = "vd55g0-cut1.bin" },
	{ .revision = 0x1120, .needs_patch = true, .fw_name = "vd55g0-cut2.bin" },
};
...
static const struct vd55g_fw_revision_map vd55g1_fw_maps[] = {
	{ .revision = 0x2020, .needs_patch = true, .fw_name = "vd55g1.bin", .builtin_fw = &vd55g1_builtin_fw },
};
...
static int vd55g_load_and_apply_patch(struct vd55g *sensor, const struct vd55g_fw_revision_map *fw_info)
{
